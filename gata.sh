...
if wget -q https://github.com/Saldarriaga184/KanekiBot-MD/raw/master/musicSH/"$random_mp3"; then
...
echo -e "\033[1;35m"
git clone https://github.com/Saldarriaga184/KanekiBot-MD.git
...
echo -e "\033[01;32m\033[01mIniciando KanekiBot!!\nStarting CatBot!!\n\033[0m"
npm start
