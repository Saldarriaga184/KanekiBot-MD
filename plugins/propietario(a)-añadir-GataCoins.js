...
if (!txt) throw `${ag}𝙄𝙉𝙂𝙍𝙀𝙎𝙀 𝙇𝘼 𝘾𝘼𝙉𝙏𝙄𝘿𝘼𝘿 𝘿𝙀 𝙆𝙖𝙣𝙖𝙠𝙞𝘾𝙤𝙞𝙣𝙨\n\n𝙀𝙉𝙏𝙀𝙍 𝙏𝙃𝙀 𝙉𝙐𝙈𝘽𝙀𝙍 𝙊𝙁 𝙂𝘼𝙏𝘼𝘾𝙊𝙄𝙉𝙎`
...
money += pjk
if (money < 1) throw `${mg}𝙀𝙇 𝙉𝙐𝙈𝙀𝙍𝙊 𝙈𝙄𝙉𝙄𝙈𝙊 𝘿𝙀 𝙆𝙖𝙣𝙖𝙠𝙞𝘾𝙤𝙞𝙣𝙨 𝙀𝙎 *1*\n\n𝙏𝙃𝙀 𝙈𝙄𝙉𝙄𝙈𝙐𝙈 𝙉𝙐𝙈𝘽𝙀𝙍 𝙁𝙍𝙊𝙈 𝙆𝙖𝙣𝙖𝙠𝙞𝘾𝙤𝙞𝙣𝙨 𝙄𝙎 *1*`
let users = global.db.data.users
users[who].money += gatacoins

conn.sendHydrated(m.chat, `╭━━━[ 𝙆𝙖𝙣𝙖𝙠𝙞𝘾𝙤𝙞𝙣𝙨 👾 ]━━━⬣\n┃\n┃ღ *PARA | FOR:*\n┃ღ *${text}*\n┃┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈\n┃ღ *SE LE AÑADIÓ | NOW YOU HAVE*\n┃ღ *${kanakicoins} KanakiCoin(s)* 🐈\n┃\n╰━━━━━━━━━━━━━━⬣`, wm, null, md, '𝙆𝙖𝙣𝙖𝙠𝙞𝘽𝙤𝙩-𝙈𝘿', null, null, [
